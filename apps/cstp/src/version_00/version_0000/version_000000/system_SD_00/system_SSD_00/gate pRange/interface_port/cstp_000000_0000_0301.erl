...
%%      This module composes orders with Procedure {PR=3, PP=1}
...
compose({Order=[{_module=0,_} | _rest], TX}, STATE) ->
    cstp_000000_0000_0301_00:compose({Order, <<TX/binary, 0>>}, STATE);
compose({Order=[{_module=1,_} | _rest], TX}, STATE) ->
    cstp_000000_0000_0301_01:compose({Order, <<TX/binary, 1>>}, STATE);
...
compute(<<Module, TX_/binary>>, STATE)
  when Module == 0->
    cstp_000000_0000_0301_00:compute(TX_, STATE);
compute(<<Module, TX_/binary>>, STATE)
  when Module == 1->
    cstp_000000_0000_0301_01:compute(TX_, STATE);
