...
%%      This module composes orders with Unit Packages Range PR = 0
%%      Procedure package PP=0; is reserved for Core Procedure Package
%%
compose({[_procedure={0,0} | Order], TX}, STATE) ->
    cstp_000000_0000_0000:compose({Order, <<TX/binary, 0>>}, STATE);
...
compute(<<Proc_Pack, TX_/binary>>, STATE)
  when Proc_Pack == 0 ->
    cstp_000000_0000_0000:compute(TX_, STATE);
compute(_TX, _STATE) ->
