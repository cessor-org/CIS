...
%%      This module composes orders with Store Packages Range PR = 2
%%      Procedure package PP=0; is reserved for Storage Procedure Package
%%
compose({[_procedure={2,0} | Order], TX}, STATE) ->
    cstp_000000_0000_0200:compose({Order, <<TX/binary, 0>>}, STATE);
...
compute(<<Proc_Pack, TX_/binary>>, STATE)
  when Proc_Pack == 0 ->
    cstp_000000_0000_0200:compute(TX_, STATE);
compute(_TX, _STATE) ->
