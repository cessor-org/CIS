...
compose({Order=[{_module=0,_} | _], TX}, STATE) ->
    cstp_000000_0000_0200_00:compose({Order, <<TX/binary, 0>>}, STATE);
compose({Order=[{_module=1,_} | _], TX}, STATE) ->
    cstp_000000_0000_0200_01:compose({Order, <<TX/binary, 1>>}, STATE);
...
compute(<<Module, TX_/binary>>, STATE)
  when Module == 0->
    cstp_000000_0000_0200_00:compute(TX_, STATE);
compute(<<Module, TX_/binary>>, STATE)
  when Module == 1->
    cstp_000000_0000_0200_01:compute(TX_, STATE);
