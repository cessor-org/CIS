...
%% @end
%%%-------------------------------------------------------------------
-module(cstp_000000_0000_0200_01).
...
%%      Call module has to be called by storage generic server
%%
compute(TX, STATE)->
...
processor_ref0({core, <<"INIT">>}, STATE)->
    io:format("storage_call, core, status: ~p~n", [<<"INIT">>]),
    TX = [
        {0,0,0},        %version
    ...
    New_state = maps:update(proc_ref, Process_refs++[Ref], STATE),
