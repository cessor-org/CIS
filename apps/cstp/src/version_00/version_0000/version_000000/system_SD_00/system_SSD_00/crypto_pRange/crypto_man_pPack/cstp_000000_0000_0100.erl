...
%%  Procedure Range = 0;        Crypto Procedure Packages Range
%%  Procedure Package = 0;      Crypto_man Procedure Package
%% @end
%%%-------------------------------------------------------------------
-module(cstp_000000_0000_0100).
...
compose({Order=[{_module=0,_} | _rest], TX}, STATE) ->
    cstp_000000_0000_0100_00:compose({Order, <<TX/binary, 0>>}, STATE);
  compose({Order=[{_module=1,_} | _rest], TX}, STATE) ->
    cstp_000000_0000_0100_01:compose({Order, <<TX/binary, 1>>}, STATE);
...
compute(<<Process_Module, TX_/binary>>, STATE)
  when Process_Module == 0->
    cstp_000000_0000_0100_00:compute(TX_, STATE);
compute(<<Process_Module, TX_/binary>>, STATE)
  when Process_Module == 1->
    cstp_000000_0000_0100_01:compute(TX_, STATE);
compute(_TX, _STATE) ->
